# PWR-MOD-006 Temperature Monitor 詳細設計
# 1. 目的
Battery、Power Board、Driver等のThermal Stateを監視しDerating判断材料を提供する。
# 2. 責務
- Temperature sampling
- Warning / Critical threshold判定
- Rate-of-rise監視
...
# 6. 内部状態
```text
Normal / Warning / Critical / SensorFaultを扱う。
```
# 7. 基本処理
```text
update()
...
を必要に応じ記録する。
# 12. 依存関係
Protection Manager、Distribution Manager、State Interface
# 13. Testとの分離
Test Caseは本書に定義しない。

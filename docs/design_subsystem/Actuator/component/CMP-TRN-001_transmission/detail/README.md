# CMP-TRN-001 Muscle Transmission Component 詳細設計 README
# 1. 目的
本書はComponent設計仕様書を実装可能な粒度へ展開する詳細設計の親文書である。
# 2. 詳細文書
- [Screw Drive 詳細設計](./screw_drive.md)
- [Tendon / Cable 詳細設計](./tendon_cable.md)
- [Simulation Model](./simulation_model.md)
- [Pulley / Linkage 詳細設計](./pulley_linkage.md)
# 3. 実装原則
- 上位要求仕様書を満たすこと。

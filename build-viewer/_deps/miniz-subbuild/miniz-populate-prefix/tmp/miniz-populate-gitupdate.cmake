...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "d10b03cc73475af673df40f06e5cefd1d5f940d9"
  WORKING_DIRECTORY "/workspaces/ai_cpp/build-viewer/_deps/miniz-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "d10b03cc73475af673df40f06e5cefd1d5f940d9")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("d10b03cc73475af673df40f06e5cefd1d5f940d9" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/d10b03cc73475af673df40f06e5cefd1d5f940d9")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"d10b03cc73475af673df40f06e5cefd1d5f940d9\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/ai_cpp/build-viewer/_deps/miniz-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/ai_cpp/build-viewer/_deps/miniz-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

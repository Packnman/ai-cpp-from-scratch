...
TensorList Dropout::forward(const TensorList& c_spmInputs)
{
...
// --------------------------
BatchNorm::BatchNorm(
    Tensor* lpGamma,Tensor* lpBeta,
    Tensor* lpRunningMean,Tensor* lpRunningVar,
...
TensorList BatchNorm::forward(const TensorList& c_spmInputs)
{
    if( (c_spmInputs.size()!=1)||(c_spmInputs[0]==nullptr) )
    {
